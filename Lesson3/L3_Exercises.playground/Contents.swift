...
var cuteAnimals : Array<CuddlyCreature>

//: 1b) Initialize an array of 5 bools using array literal syntax.
//cuteAnimals = ["dog", "cat", "bird", "pig", "cow"] as! CuddlyCreature
...
dictionary = ["Anchovies":false, "Coconut": false, "Cilantro":true, "Liver":false]
