...
for (foodd, bool) in polarizingFoods{
    if bool{
        print("\(foodd), yum!")
    }else{
        print("\(foodd), yuck!")
...
var newRapperPhoneNumbers = [String:String]()

for (name,contact) in rapperPhoneNumbers{
    rapperPhoneNumbers[name] = contact.replacingOccurrences(of: "(415)", with: "(510)")
}
//: ## Switch Statements
