...
struct Cookie{
    ...
    var delicious: Bool{
        if(minutesSinceRemovalFromOven) > 1{
            return true
        }else {
            return false
        }
...
var cookie = Cookie(flavor: "pineApple", minutesSinceRemovalFromOven: 2, bite: 0        )
cookie.delicious
cookie.bite
...
var house = BedAndBreakfast(category: House.House.rawValue, availability: true, laundry: true)
