...
if let useDirector = director{
    print ("\(useDirector) exists")
}else{
    print ("no exists")

}
//: 1b) Test your code by inserting different values for the variable `movie`.
var secondMovie = "Avangers"
var secondDirector = moviesDict[secondMovie]

if let useDirector = secondDirector{
    print ("\(useDirector) exists")
}else{
    print ("no exists")
...
var NewnumericalString = "three"

//var Newnumber = Int(NewnumericalString)
//print("\(Newnumber) is the magic number.")
//: ### Exercise 4
...
var Newpainting = "The Kiss"
var Newartist = paintingDict[Newpainting]

if let result = Newartist{
    print("\(result)")
}else{
    print("no result")
}
...
if childViewController != nil{
    var parent = childViewController.parent
}
